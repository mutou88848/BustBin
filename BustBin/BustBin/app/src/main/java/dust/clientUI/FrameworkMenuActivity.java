...
import com.dust.R;
import dust.clientBase.adapter.ChoiceAdapter;
...
public class FrameworkMenuActivity extends FragmentActivity implements OnClickListener {
	...
	private String[] array_msg = new String[] { "关于我们" , "软件信息"};
...
//				else if(position==2){
//					Intent mbtnExame = new Intent(FrameworkMenuActivity.this, MyOrderActivity.class);
//					FrameworkMenuActivity.this.startActivity(mbtnExame);
//				}else if(position==3){
//					Intent mbtnExame = new Intent(FrameworkMenuActivity.this, AboutActivity.class);
//					FrameworkMenuActivity.this.startActivity(mbtnExame);
