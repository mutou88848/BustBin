...
public class RepairListActivity extends BaseActivity {
	...
	private List<RepairModel> list_result = new ArrayList<RepairModel>();
	private LinearLayout mllNomessage;
	RepairAdapter orderListAdapter;
	...
	private void MessageAction(boolean isShow) {
		...
		params.put("action_flag", "listRepairPhone");
			...
			case Consts.actionId.resultFlag:
				if (null != entry.getData() && !TextUtils.isEmpty(entry.getData())) {
					...
					if (null != jsonMsg && !TextUtils.isEmpty(jsonMsg)) {
						list_result = mGson.fromJson(entry.getData(), new TypeToken<List<RepairModel>>() {
						}.getType());
						orderListAdapter = new RepairAdapter(RepairListActivity.this, list_result);
