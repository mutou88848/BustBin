...
public class UpdateNameActivity extends BaseActivity {
	...
	public void initWidget() {
		...
		metName.setHint("当前余额"+userModel.getUserMoney()+"元");
	...
	private void RegisterAction(boolean isShow) {
		...
		params.put("userMoney", metName.getText().toString());
	...
	protected void callBackSuccess(ResponseEntry entry, int actionId) {
		...
		UserModel userModel = (UserModel) MemberUserUtils.getBean(this, "user_messgae");
		userModel.setUserMoney((Integer.valueOf(metName.getText().toString())+Integer.valueOf(userModel.getUserMoney()))+"");
